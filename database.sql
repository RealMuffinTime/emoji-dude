...
CREATE TABLE IF NOT EXISTS `set_guilds` (
  ...
  `member_join_bool_enabled` tinyint(1) NOT NULL DEFAULT 0,
  `member_join_text_channel_channel` BIGINT(18) DEFAULT NULL,
  `member_join_variable_message` VARCHAR DEFAULT '%user% just joined!',
  `member_join_role_auto_role` BIGINT(18) DEFAULT NULL,
  `member_leave_bool_enabled` tinyint(1) NOT NULL DEFAULT 0,
  `member_leave_text_channel_channel` BIGINT(18) DEFAULT NULL,
  `member_leave_variable_message` VARCHAR DEFAULT '%user% has parted ways with us.',
